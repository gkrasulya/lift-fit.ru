...
urlpatterns = patterns('',
	...
	url(r'^proizvoditel/(?P<slug>[-\w\d_]+)-(?P<id>\d+)/$', spares.views.index, name='spares-producer-detail'),
	url(r'^catalog/(?P<slug>[-\w\d_]+)-(?P<id>\d+)/$', spares.views.index, name='spares-index-producer'),
