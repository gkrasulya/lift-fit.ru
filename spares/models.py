...
class Order(models.Model):
	STATUSES = (
		(0, u'Заказ принят и отправлен на обработку'),

		(1, u'Заказ сформирован и отправлен поставщику'),
		(2, u'Заказ упакован и готов к отправке'),
		(3, u'Заказ отправлен на транзитный склад в Европе'),
		(4, u'Заказ поступил на транзитный склад'),
		(5, u'Заказ отправлен в Россию'),
		(6, u'Заказ поступил на таможню и проходит таможенную очистку'),
		(7, u'Заказ поступил на склад в Москве'),
		(8, u'Заказ отправлен в адрес Заказчика'),
		(9, u'Заказ получен Заказчиком'),
	...
	status = models.IntegerField(u'Статус', choices=STATUSES, max_length=255, default=33)
